...
<head>
    ...
    <title>GYMATE - Tambah Catatan Latihan Baru</title>
    ...
    {{-- Font Inter sudah diatur melalui Tailwind dan CDN di atas --}}
</head>
<body class="bg-gray-300 font-sans h-screen flex flex-col">
    ...
    <div class="flex flex-1 w-full p-8 items-center justify-center overflow-y-auto">
        <div class="bg-white p-8 rounded-2xl shadow-2xl max-w-2xl w-full"> {{-- Menyesuaikan max-w agar tidak terlalu lebar --}}
            <h1 class="text-2xl font-semibold uppercase pb-8 text-center text-gray-900 border-b border-gray-200">Tambah Catatan Latihan Baru</h1>
            ...
            <form action="{{ route('pelanggan.catatan.store') }}" method="POST" class="space-y-6">
                @csrf
                <div class="mb-4">
                    ...
                    <input type="date" name="tanggal_latihan" id="tanggal_latihan"
                           ...
                           value="{{ old('tanggal_latihan') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea type="text" name="kegiatan_latihan" id="kegiatan_latihan"
                           ...
                           value="{{ old('kegiatan_latihan') }}" placeholder="Contoh: Latihan Dada & Trisep" required rows="5"></textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="catatan_latihan" id="catatan_latihan" rows="5"
                              ...
                              placeholder="Catatan detail tentang latihan (opsional)">{{ old('catatan_latihan') }}</textarea>
