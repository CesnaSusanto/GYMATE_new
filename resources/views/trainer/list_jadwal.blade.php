    ...
    <div class="container mx-auto p-8">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <div class="flex items-center mb-6">
                {{-- Tombol KEMBALI --}}
                {{-- Mengarah kembali ke dashboard Personal Trainer --}}
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between bg-gray-100 border border-gray-300 rounded-lg p-4 shadow-sm">
                        ...
                        <div class="flex-shrink-0 flex items-center space-x-2 ml-4">
                            {{-- Tombol Edit --}}
                            <a href="{{ route('trainer.jadwal.edit', $kartu->id_kartu) }}" class="text-blue-600 hover:text-blue-800 transition duration-300" title="Edit Sesi Latihan">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                            </a>
                            {{-- Tombol Delete --}}
                            <form action="{{ route('trainer.jadwal.destroy', $kartu->id_kartu) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus sesi latihan ini?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-600 hover:text-red-800 transition duration-300" title="Hapus Sesi Latihan">
